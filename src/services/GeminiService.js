 ...
 * @param {string} modelName - The Gemini model to use (defaults to 'gemini-1.5-flash')
 * @returns {Promise<string>} The model's response text
 */
export const generateGeminiResponse = async (prompt, modelName = 'gemini-1.5-flash') => {
  if (!API_KEY || !genAI) {
